...
export const AnalystCampaignControllerApiAxiosParamCreator = function (
	...
	return {
		...
		deleteAnswerById: async (
			...
			assertParamExists('deleteAnswerById', 'answerId', answerId);
			const localVarPath = `/api/analyst/campaign/delete-answer/{answerId}`.replace(
				`{${'answerId'}}`,
		 ...
		 * @throws {RequiredError}
		 */
		getAllCampaignsOngoingAndComplete: async (
			acceptLanguage?: 'en-US' | 'it-IT' | 'fr-FR',
			options: AxiosRequestConfig = {}
		): Promise<RequestArgs> => {
			const localVarPath = `/api/analyst/campaign/allOngoingAndCompleteAndAnnulled`;
			// use dummy base URL string because the URL constructor only accepts absolute URLs.
			const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
			let baseOptions;
			if (configuration) {
...
export const AnalystCampaignControllerApiFp = function (configuration?: Configuration) {
	...
	return {
		...
		async deleteAnswerById(
			...
			const localVarAxiosArgs = await localVarAxiosParamCreator.deleteAnswerById(
				answerId,
				acceptLanguage,
				options
			);
		 ...
		 * @throws {RequiredError}
		 */
		async getAllCampaignsOngoingAndComplete(
			acceptLanguage?: 'en-US' | 'it-IT' | 'fr-FR',
			options?: AxiosRequestConfig
		): Promise<
			(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<CampaignDto>>
		> {
			const localVarAxiosArgs =
				await localVarAxiosParamCreator.getAllCampaignsOngoingAndComplete(
					acceptLanguage,
					options
				);
			return createRequestFunction(
...
export const AnalystCampaignControllerApiFactory = function (
	...
	return {
		...
		deleteAnswerById(
			...
			return localVarFp
				.deleteAnswerById(answerId, acceptLanguage, options)
				.then(request => request(axios, basePath));
		},
		/**
		 *
		 ...
		 * @throws {RequiredError}
		 */
		getAllCampaignsOngoingAndComplete(
			acceptLanguage?: 'en-US' | 'it-IT' | 'fr-FR',
			options?: any
		): AxiosPromise<Array<CampaignDto>> {
			return localVarFp
				.getAllCampaignsOngoingAndComplete(acceptLanguage, options)
				.then(request => request(axios, basePath));
		},
		/**
		 *
...
/**
 * Request parameters for deleteAnswerById operation in AnalystCampaignControllerApi.
 * @export
 * @interface AnalystCampaignControllerApiDeleteAnswerByIdRequest
 */
export interface AnalystCampaignControllerApiDeleteAnswerByIdRequest {
	/**
	 *
	 * @type {number}
	 * @memberof AnalystCampaignControllerApiDeleteAnswerById
	 */
...
/**
 * Request parameters for getAllCampaignsOngoingAndComplete operation in AnalystCampaignControllerApi.
 * @export
 * @interface AnalystCampaignControllerApiGetAllCampaignsOngoingAndCompleteRequest
 */
export interface AnalystCampaignControllerApiGetAllCampaignsOngoingAndCompleteRequest {
	/**
	 *
	 * @type {'en-US' | 'it-IT' | 'fr-FR'}
	 * @memberof AnalystCampaignControllerApiGetAllCampaignsOngoingAndComplete
	 */
	readonly acceptLanguage?: 'en-US' | 'it-IT' | 'fr-FR';
}
...
export class AnalystCampaignControllerApi extends BaseAPI {
	...
	/**
	 *
	 * @param {AnalystCampaignControllerApiDeleteAnswerByIdRequest} requestParameters Request parameters.
	 * @param {*} [options] Override http request option.
	 * @throws {RequiredError}
	 * @memberof AnalystCampaignControllerApi
	 */
	public deleteAnswerById(
		requestParameters: AnalystCampaignControllerApiDeleteAnswerByIdRequest,
		options?: AxiosRequestConfig
	) {
		return AnalystCampaignControllerApiFp(this.configuration)
			.deleteAnswerById(
	...
	/**
	 *
	 * @param {AnalystCampaignControllerApiGetAllCampaignsOngoingAndCompleteRequest} requestParameters Request parameters.
	 * @param {*} [options] Override http request option.
	 * @throws {RequiredError}
	 * @memberof AnalystCampaignControllerApi
	 */
	public getAllCampaignsOngoingAndComplete(
		requestParameters: AnalystCampaignControllerApiGetAllCampaignsOngoingAndCompleteRequest = {},
		options?: AxiosRequestConfig
	) {
		return AnalystCampaignControllerApiFp(this.configuration)
			.getAllCampaignsOngoingAndComplete(requestParameters.acceptLanguage, options)
			.then(request => request(this.axios, this.basePath));
	}
