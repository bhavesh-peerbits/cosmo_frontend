...
import {
	...
	RunMonitoringAsset
} from '@pages/ChangeMonitoring/MonitoringDraftDetails/types/RunMonitoringAsset';
import { PathMonitoringDto } from 'cosmo-api/src/v1';
import { useState } from 'react';
import { useForm } from 'react-hook-form';
import { useTranslation } from 'react-i18next';
import cx from 'classnames';
import SameSetupPathTable from '@pages/ChangeMonitoring/MonitoringDraftDetails/Components/SameSetupPathTable';
import AssetExpandableTile from '@pages/ChangeMonitoring/MonitoringDraftDetails/Components/AssetExpandableTile';
import PathAssetTable from '@pages/ChangeMonitoring/MonitoringDraftDetails/Components/PathAssetTable';
