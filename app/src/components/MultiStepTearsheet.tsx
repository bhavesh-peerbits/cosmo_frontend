...
// 	const [stepThreeTextInputValue, setStepThreeTextInputValue] = useState('one-day');
...
// 				label={label}
// 				className={cx('opacity-0', className)}
...
// 							onChange={(e, { checked }) => setShouldIncludeAdditionalStep(checked)}
...
// 						min={1}
// 						max={100}
// 						iconDescription='Number of partitions'
...
// 						onChange={event => setStepTwoTextInputValue(event.imaginaryTarget.value)}
// 					/>
// 				</CreateTearsheetStep>
// 				<CreateTearsheetStep
